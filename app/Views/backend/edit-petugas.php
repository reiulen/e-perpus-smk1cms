                ...
                <form method="POST" action="<?= base_url(); ?>/auth/tambahPetugas" class="needs-validation" novalidate="">
                    ...
                    <div class="form-row my-3">
                        <div class="form-group col-md-3">
                            <button type="submit" id="submit" name="submit" class="btn btn-primary btn-lg btn-block">Simpan</button>
                        </div>
                  </form>
                        <div class="form-group col-md-3">
                            <button type="submit" name="submit" id="batal" class="btn btn-danger btn-lg btn-block">Batal</button>
                        </div>
                    </div>
              </div>
            </div>
